...
처음부터 수십수백 줄의 코드를 막힘 없이 짜낼 수 없습니다. 항상 단계 별로 조금씩 코드를 작성해보시고, 공부한 내용을 정리하고 글로 작성해두는 습관을 들이면 공부하는 데 도움이 될 거라 생각합니다. 틈틈이 알고리즘 공부도 하시는 거 잊지 마세요! 정말 고생 많으셨습니다. 감사합니다. :)